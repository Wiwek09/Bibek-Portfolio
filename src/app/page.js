    ...
    <div className=''>
      ...
      <section className='dark:bg-gray-950 md:pl-20 md:pr-20 p-10 md:px-18 bg-yellow-100 flex flex-col md:flex-row gap-6 min-h-fit'> {/*Section of about me and skills*/}
        ...
        <div className='w-full md:ml-12 md:w-[50%] tracking-wide'>
          ...
          <section className=' md:text-2xl text-l text-green-600 mt-4 font-serif' >3. DATA ANALYTICS AND VISUALIZATION
      ...
      <section className='align-middle my-20'> {/* Section for my project */}
       <main className='w-full space-y-4' >
        ...
        <footer className='flex flex-col justify-center items-center' >
          <div>
            <button  className=' text-2xl md:text-3xl cursor-pointer md:mb-3  hover:text-teal-600 border rounded-full p-2 flex items-center justify-center hover:bg-yellow-300 transition duration-300 ease-out' 
